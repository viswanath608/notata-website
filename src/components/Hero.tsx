...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-svh w-full max-w-6xl flex-col justify-center px-6 pb-24 pt-32 sm:px-10 sm:pt-36">
        <Enter delay={0.1}>
          <div className="glass inline-flex w-fit items-center gap-2.5 rounded-md px-3.5 py-1.5">
            ...
            <span className="font-mono text-[0.65rem] uppercase tracking-[0.18em] text-muted-foreground sm:text-[0.7rem] sm:tracking-[0.22em]">
              In stealth · Onboarding early partners
            </span>
          </div>
        </Enter>
        ...
        <Enter delay={0.4}>
          <p className="mt-7 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Notata is building the marketplace where AI companies license
            authentic, rights‑cleared data — contributed, verified and priced
        ...
        <Enter delay={0.55} className="mt-10 flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="glass h-12 rounded-lg border-border bg-transparent px-7 text-base text-cream transition-all duration-300 hover:bg-secondary hover:text-cream"
          >
            <a href="#products">
